    $(function () {
      ...
      function next() {
        if (a==6 && c==6) {
          ...
          if (a>1) {cl.html("Llevas: "+a+" juguetes")}
          if (c>1) {cl2.html("Llevas: "+c+" juguetes")}
        if (a>6 || c>6) { 
          $('#image').attr('src','../img/carga.gif');
      ...
      function acierto(){
       ...
       alert("hay 6 juguetes para cada caja: correcto");
          location.href='reparto9.html';
      }
      function error(){
        v2.play();
        $('#image').removeAttr('src')
