$(function () {
    ...
    numeradores = ["uno","dos","tres","cuatro","cinco","seis","siete","ocho","nueve","diez","once","doce","trece","catorce",
        ...
        "treinta y dos","treinta y tres","treinta y cuatro","treinta y cinco","treinta y seis","treinta y siete",
        "treinta y ocho","treinta y nueve","cuarenta","cuarenta y uno","cuarenta y dos","cuarenta y tres","cuarenta y cuatro",
        "cuarenta y cinco","cuarenta y seis","cuarenta y siete","cuarenta y ocho","cuarenta y nueve","cincueta","cincueta y uno",
        "cincueta y dos","cincueta y tres","cincueta y cuatro","cincueta y cinco","cincueta y seis","cincueta y siete",
        "cincueta y ocho","cincueta y nueve","sesenta","sesenta y uno","sesenta y dos","sesenta y tres","sesenta y cuatro",
        "sesenta y cinco","sesenta y seis","sesenta y siete","sesenta y ocho","sesenta y nueve","setenta","setenta y uno",
        "setenta y dos","setenta y tres","setenta y cuatro","setenta y cinco","setenta y seis","setenta y siete",
        "setenta y ocho","setenta y nueve","ochenta","ochenta y uno","ochenta y dos","ochenta y tres","ochenta y cuatro",
        "ochenta y cinco","ochenta y seis","ochenta y siete","ochenta y ocho","ochenta y nueve","noventa","noventay uno",
        "noventa y dos","noventa y tres","noventa y cuatro","noventa y cinco","noventa y seis","noventa y siete",
    ...
    function suma(num, num2, den, den2) {
        var arriba,abajo;
        if (den == den2) {
            abajo = den;
            arriba = num + num2;
        } else {
            arriba = (num * den2) + (num2 * den);
            abajo = (den * den2);
        }
        simplificar(arriba, abajo);
    }
    ...
    function dibujar(num, den)
    {
        img1.attr('src', '../fracciones/' + num + '.png');
        document.getElementById("num").style.display='block';
        // document.getElementById("raya3").style.display='block';
        img2.attr('src', '../fracciones/' + den + '.png');
        document.getElementById("den").style.display='block';
    }
    var img = $('#resultado');
